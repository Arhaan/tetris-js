...
function draw_grid() {
    ...
    ctx.stroke();
    ctx.closePath();
    squares[0][19].movementStatus = 2;
    squares[1][19].movementStatus = 2;
    squares[2][19].movementStatus = 2;
    squares[3][19].movementStatus = 2;
    squares[6][19].movementStatus = 2;
    squares[7][19].movementStatus = 2;
    squares[8][19].movementStatus = 2;
    squares[9][19].movementStatus = 2;
